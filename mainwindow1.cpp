    ...
    , ui(new Ui::MainWindow1)
{
    ...
    connect(ui->locauxButton, &QPushButton::clicked, this, &MainWindow1::onLocauxClicked);
    ...
    connect(timer, &QTimer::timeout, this, &MainWindow1::updateTemperature);
    ...
    connect(ui->pushButtonSend, &QPushButton::clicked, this, &MainWindow1::sendEmailWithPostmark);
    connect(ui->clients, &QPushButton::clicked, this, &MainWindow1::showClientPage1);
    connect(ui->employee, &QPushButton::clicked, this, &MainWindow1::showEmployeePage1);
    connect(ui->factures, &QPushButton::clicked, this, &::MainWindow1::showFacturePage1);

}
void MainWindow1::on_vehicleButton_clicked() {
    emit switchToVehicle();
}

void MainWindow1::on_locauxButton_clicked() {
    emit switchToLocaux();
}
...
void MainWindow1::onLocauxClicked() {
    GestionL* gestionLWindow = new GestionL(this);  // Pass 'this' to set MainWindow1 as the parent
    gestionLWindow->setAttribute(Qt::WA_DeleteOnClose);
    gestionLWindow->show();

    connect(gestionLWindow, &GestionL::someSignal, this, [this, gestionLWindow]() {
        // Handle any specific signals if needed
        this->show();  // Optionally re-show MainWindow1 if it should be visible alongside
        gestionLWindow->close();  // Ensure GestionL window is closed if no longer needed
    });

    this->hide();  // Optionally hide MainWindow1 when GestionL is displayed
}
void MainWindow1::populateStatutComboBox() {
    ui->comboBox_statut->addItem(" libre");
    ui->comboBox_statut->addItem("non libre ");

}

void MainWindow1::on_ajouter_equi_clicked()
{
...
void MainWindow1::on_modifer_equi_clicked()
{
...
void MainWindow1::on_recherche_equi_clicked()
{
...
void MainWindow1::on_tableView_equipement_doubleClicked(const QModelIndex &index)
{
...
void MainWindow1::on_supp_equi_clicked()
{
...
void MainWindow1::on_tri_equi_clicked()
{
...
void MainWindow1::on_statistique_equi_clicked() {
    // Retrieve statistics
...
void MainWindow1::on_export_pdf_clicked()
{
...
{
    ui->tabWidget->setCurrentWidget(ui->tab_4); // Assuming historique is in a tab
}

//mail
void MainWindow1::sendEmailWithPostmark() {
...
void MainWindow1::on_pushButtonSend_clicked()
{
...
void MainWindow1::updateTemperatureInDatabase(float temperature)
{
...
void MainWindow1::updateTemperature()
{
    QByteArray data = arduino.readFromArduino();  // Read data from Arduino
